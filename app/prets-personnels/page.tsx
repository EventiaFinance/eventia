...
export default function PersonalLoansPage() {
  const { t } = useLanguage()
  const pageData = t.pages?.personal
    ...
    <>
      ...
      <main className="bg-background min-h-screen">
        ...
        <section className="relative overflow-hidden bg-primary text-primary-foreground">
          <img
            src="/images/service-personnel.png"
            alt=""
        ...
        <section className="mx-auto max-w-5xl px-4 py-16">
          <div className="grid gap-12 md:grid-cols-5">
            ...
            <div className="md:col-span-2 rounded-xl border border-border bg-card p-6 shadow-sm h-fit">
              <h2 className="text-xl font-bold text-primary mb-6">
                {pageData.advantagesTitle}
              </h2>
              <ul className="flex flex-col gap-4">
                {pageData.advantages.map((adv, index) => (
